  ...
  try {
    ...
    const addCols = USE_PG
      ? [
          ...
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS delivery_status VARCHAR(12) DEFAULT 'PENDING'`,
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS delivered_at TIMESTAMP`,
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS delivered_by UUID`,
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS taken_at TIMESTAMP`,
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS taken_by UUID`,
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS delivery_address TEXT`,
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS delivery_lat NUMERIC(10,6)`,
          `ALTER TABLE sales ADD COLUMN IF NOT EXISTS delivery_lng NUMERIC(10,6)`,
      ...
      : [
          ...
          `ALTER TABLE sales ADD COLUMN delivered_by TEXT`,
          `ALTER TABLE sales ADD COLUMN taken_at TEXT`,
          `ALTER TABLE sales ADD COLUMN taken_by TEXT`,
          `ALTER TABLE sales ADD COLUMN delivery_address TEXT`,
          `ALTER TABLE sales ADD COLUMN delivery_lat REAL`,
          `ALTER TABLE sales ADD COLUMN delivery_lng REAL`,
