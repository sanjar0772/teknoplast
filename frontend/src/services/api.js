...
export const productsAPI = {
  ...
  bulkDelete: (ids, force = false) => api.post('/products/bulk-delete', { ids, force }),
  ...
  inventoryAdjust: (items, reason) => api.post('/products/inventory-adjust', { items, reason }),
  inventoryHistory: (params) => api.get('/products/inventory-adjust/history', { params }),
